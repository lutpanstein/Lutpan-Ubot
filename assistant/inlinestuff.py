...
lutpanpic = "https://graph.org/file/ad02750e78083a8c57e90.jpg"
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            thumb=wb(lutpanpic, 0, "image/jpeg", []),
            text="**〄 ʟᴜᴛᴘᴀɴ ɢᴀᴄᴏʀ 〄**",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="Lutpan Repo.", switch_pm_param="start")
...
async def inline_tl(ay):
    ...
    await ay.answer(res[:50], switch_pm=mo, switch_pm_param="start")
...
InlinePlugin.update(
    {
        ...
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter kazusupportgrp",
