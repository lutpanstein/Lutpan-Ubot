...
from Lutpan import lutpan_bot
from Lutpan._misc._supporter import CMD_HNDLR, CMD_HELP
from Lutpan.dB import DEFAULT, DEVLIST
    ...
    def decorator(func):
        ...
        if lutpan_bot:
            if not disable_edited:
                lutpan_bot.add_event_handler(wrapper, events.MessageEdited(**args))
            lutpan_bot.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
