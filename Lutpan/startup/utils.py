...
def load_addons(plugin_name):
    ...
    if base_name.startswith("__"):
        return
    from .. import HNDLR, LOGS, asst, udB, lutpan_bot
    ...
    mod.asst = asst
    mod.tgbot = asst
    mod.lutpan_bot = lutpan_bot
    mod.ub = lutpan_bot
    mod.bot = lutpan_bot
    mod.lutpan = lutpan_bot
    mod.borg = lutpan_bot
    mod.telebot = lutpan_bot
    mod.jarvis = lutpan_bot
    mod.friday = lutpan_bot
    mod.eod = eod
    mod.edit_delete = eod
    mod.LOGS = LOGS
    ...
    mod.lutpan_cmd = lutpan_cmd
    mod.on_cmd = lutpan_cmd
