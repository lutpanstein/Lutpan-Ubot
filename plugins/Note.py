...
from Lutpan.dB.notes_db import add_note, get_notes, list_note, rem_note
...
@lutpan_cmd(pattern="addnote( (.*)|$)", admins_only=True)
async def an(e):
...
@lutpan_cmd(pattern="listnote$", admins_only=True)
async def lsnote(e):
