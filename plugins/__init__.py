...
from Lutpan.dB import DEVLIST, LUTPAN_IMAGES, DEFAULT 
from Lutpan.fns.ytdl import get_videos_link
from Lutpan.fns.helper import *
from Lutpan.fns.info import *
from Lutpan.fns.misc import *
from Lutpan.fns.tools import *
from Lutpan.version import lutpan_version, __version__ as LutpanVer
...
def inline_pic():
    ...
    if INLINE_PIC is None:
        INLINE_PIC = choice(LUTPAN_IMAGES)
    ...
    async def play_from_queue(self):
        ...
        try:
            ...
            await vcClient.send_message(
                self._current_chat,
                f"◈ Berhasil Meninggalkan Vc : <code>{chat_id}</code> •",
                parse_mode="html",
            )
        ...
        async def vc_handler(e):
            ...
            try:
                ...
                await asst.send_message(
                    LOG_CHANNEL,
                    f"VC Error - <code>{LutpanVer}</code>\n\n<code>{e.text}</code>\n\n<code>{format_exc()}</code>",
                    parse_mode="html",
                )
