...
from Lutpan.fns.google_image import googleimagesdownload
from Lutpan.fns.tools import metadata
...
@lutpan_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by Lutpan Ubot", file=file)
    os.remove(file)
    await msg.delete()
    return message
