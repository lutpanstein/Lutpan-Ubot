...
from . import eod, eor, get_string, mediainfo, lutpan_cmd
...
@lutpan_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@lutpan_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@lutpan_cmd(pattern="setfp$", fullsudo=True)
async def _(ayra):
...
@lutpan_cmd(pattern="delfp( (.*)|$)", fullsudo=True)
