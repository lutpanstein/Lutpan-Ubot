...
from Lutpan.dB.gcast_blacklist_db import (
    add_gblacklist,
    is_gblacklisted,
    rem_gblacklist,
)
...
@lutpan_cmd(pattern="g(admin|)cast( (.*)|$)", fullsudo=False)
async def gcast(event):
    ...
    if err != "":
        ...
        text += f"\Anda dapat melakukan `{HNDLR}lutpan gcast-error.log` untuk mengetahui laporan kesalahan."
    await kk.edit(text)
